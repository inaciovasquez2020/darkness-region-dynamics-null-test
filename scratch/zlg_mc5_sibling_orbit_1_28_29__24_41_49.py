#!/usr/bin/env python3
"""Fail-closed verifier for size-7 sibling orbit ((1,28,29),(24,41,49))."""
from itertools import product

PAIR = ((1, 28, 29), (24, 41, 49))
...
def unsimplified(vals):
    ...
    # Pi1=<x1,a1+x3+x4>, Pi2=<x3+x4,x1+x3+a2>.
...
def main():
    ...
    print(
        ...
        "pair=((1,28,29),(24,41,49)) orbit_size=2 "
    ...
    print("LEVEL5_SIBLING_SIZE7_ORBIT_1_28_29__24_41_49_CLOSED")
